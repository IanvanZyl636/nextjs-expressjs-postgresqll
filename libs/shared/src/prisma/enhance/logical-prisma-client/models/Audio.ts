...
export type AudioCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<AudioFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface AudioDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
     */
    count<T extends AudioCountArgs>(args?: Prisma.Subset<T, AudioCountArgs>): Prisma.PrismaPromise<
    ...
    groupBy<T extends AudioGroupByArgs, HasSelectOrTake extends Prisma.Or<
        ...
        : {
            [P in OrderFields]: P extends ByFields
              ? never
              : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`
          }[OrderFields]>(args: Prisma.SubsetIntersection<T, AudioGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetAudioGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
}
